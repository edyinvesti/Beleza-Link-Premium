...
export default function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-gradient-to-t from-zinc-950 via-zinc-950/95 to-zinc-950/90 backdrop-blur-xl border-t border-white/10 px-4 py-3 z-50 flex items-center justify-around pb-safe">
