  ...
  return (
    <header className="h-20 flex items-center justify-between px-8 bg-black/20 backdrop-blur-md sticky top-0 z-[40] border-b border-white/[0.02]">
      <div className="flex items-center gap-4 bg-zinc-900/30 px-4 py-2 rounded-xl border border-white/5 w-64">
        ...
        <input type="text" placeholder="BUSCAR..." className="bg-transparent border-none outline-none text-[10px] font-bold tracking-widest uppercase w-full text-white" />
      </div>
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 text-right">
          ...
          <button onClick={onLogout} className="w-10 h-10 rounded-xl bg-zinc-900 border border-white/10 flex items-center justify-center hover:border-red-500/50 group transition-all">
