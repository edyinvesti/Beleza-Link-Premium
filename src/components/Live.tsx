    ...
    <div className="min-h-screen bg-[#050505] text-white pt-24 pb-12 px-4 md:px-12 font-sans selection:bg-[#F97316]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="lg:col-span-3 space-y-8">
          ...
          {/* VÍDEO COM LINK DIRETO DA CLOUDINARY (RESISTENTE) */}
          <div className="aspect-video bg-zinc-900 rounded-[50px] border border-white/5 relative overflow-hidden shadow-2xl">
             <video 
               ...
               playsInline 
             >
               <source src="https://res.cloudinary.com/demo/video/upload/q_auto,f_auto/docs/beauty-spa.mp4" type="video/mp4" />
          ...
          <div className="flex items-center justify-between bg-zinc-900/30 backdrop-blur-xl p-6 rounded-[35px] border border-white/5">
             <p className="hidden md:block text-zinc-500 text-[10px] uppercase font-bold tracking-[0.2em]">O Futuro da Área da Beleza</p>
             <button onClick={() => setIsSharing(true)} className="bg-white text-black px-10 py-5 rounded-[22px] font-black text-[10px] uppercase tracking-widest hover:bg-[#F97316]">
                Compartilhar
             </button>
          </div>
        </div>
